...
export default function CardInfo({budgetList}: {budgetList: budgetQuery[]}){
  ...
  const CalculateCardInfo = () =>{
    let totalBudget_ = 0;
    let totalSpent_ = 0;
    Object.values(budgetList).forEach(element => {
      totalBudget_ = totalBudget_ + Number(element.amount);
      totalSpent_ = totalSpent_ + (element.totalSpent ? element.totalSpent : 0);
    })
